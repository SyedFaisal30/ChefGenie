...
const CreatePostForm = ({ addPost }) => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.post("http://localhost:8000/api/users/create-post", postData, {
        headers: {
  ...
  return (
    <div className="mt-6">
      <h3 className="text-xl font-bold text-center text-yellow-600 mb-4">Create a New Post</h3>
